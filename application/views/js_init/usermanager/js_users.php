...
$("#users_container").load('<?php echo site_url('usermanager/add_user')?>', { 'type': type, 'param1': param1 }, function() {
$(this).dialog({
	title: user_title,
	modal: true,
	show: 'fade',
	...
	'<?php echo lang('kalkun_save');?>': function() {
		if($("#addUser").valid()) {
		$.post("<?php echo site_url('usermanager/add_user_process') ?>", $("#addUser").serialize(), function(data) {
...
var dest_url = '<?php echo site_url('usermanager/delete_user') ?>';
if(count==0) { 
