...
<div class="message_container <?php if($tmp['source'] == 'inbox' && $tmp['published']=='false') echo 'unpublished';?>" source="<?php echo $tmp['source'];?>">
    ...
    <input  type="hidden" class="item_id_folder" name="item_id_folder<?php echo $tmp['ID'];?>"  id="item_id_folder<?php echo $tmp['ID'];?>"  value="<?php echo $id_folder; ?>" />
    <input  type="hidden" class="item_id_inbox" name="item_id_inbox<?php echo $tmp['ID'];?>"  id="item_id_inbox<?php echo $tmp['ID'];?>"  value="<?php echo $tmp['ID']; ?>" />
	<input type="checkbox" id="<?php echo $tmp['ID'];?>" id_message="<?php echo $tmp['ID'];?>" class="select_message nicecheckbox select_conversation" value="<?php echo $tmp['ID'];?>" style="border: none;" />
