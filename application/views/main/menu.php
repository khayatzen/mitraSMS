<ul>
<li class="menu_header"><?php echo anchor('admin',lang('kalkun_dashboard')); ?></li>
<li><a href="#" id="compose_sms_normal" class="compose_button" style="color:#333;"><?php echo lang('kalkun_compose');?></a></li>
<li>
	<span style="color: #FFF;" class="menu_header"><?php echo lang('kalkun_folder');?></span>
	<div id="f_child_menu">
	<ul>
	<li>
...
if($level=='administrator'):?>
	<li><?php echo anchor('usermanager',lang('tni_user_wordp')); ?></li>
...
if($level=='admin'):?>
	<li>
    <span style="color: #FFF;" class="menu_header"><?php echo anchor('statistic','Statistik');?></span>
	</li>
<?php endif; ?>
<!--
<li>
	<div style="float: left" class="menu_header"><span style="color: #FFF;"><?php echo lang('kalkun_myfolder');?></span></div>
