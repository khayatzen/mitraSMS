<?php $this->load->view('js_init/usermanager/js_add_user');?>
...
<input type="text" name="real_name" id="real_name" value="<?php if(isset($users)) echo $users->row('real_name');?>" class="text ui-widget-content ui-corner-all" />
...
echo form_dropdown('level', $levels, $level_act, $option);
?>
