<?php $this->load->view('js_init/usermanager/js_users');?>
...
<div id="window_content">
	<?php $this->load->view("main/usermanager/navigation");?>
	<div id="users_list"><?php $this->load->view('main/usermanager/users_list');?></div>
	<?php $this->load->view("main/usermanager/navigation");?>
</div>
</div>
