...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Borneo Climate';
...
$config['login_attempt_expire'] = 120*120*24;
...
$config['autologin_cookie_life'] = 120*60*24*31*2;
...
$config['recaptcha_public_key'] = '';//6Lew38gSAAAAAAdBV-Mw0GNIZCWRG8yycRWIAiQt
$config['recaptcha_private_key'] = '';//6Lew38gSAAAAAKBMZU87Z3krKdbQbdt_YIypuqlc
...
|--------------------------------------------------------------------------
*/
$config['db_table_prefix'] = 'auth_';


/*
 * ------------------------------------------------------------------------
 * Title and Description Form Auth
 * title = Title of form
 * description = form description
 * ------------------------------------------------------------------------
 */
$config['login_form']['title'] = 'Masuk Log';
$config['login_form']['description'] = 'Silakan masukkan username/email dan kata sandi anda untuk masuk log';

$config['register_form']['title'] = 'Bergabung menjadi Pelapor';
$config['register_form']['description'] = 'Silakan isi formulir di bawah ini';

$config['reset_password_form']['title'] = 'Mereset kata sandi';
$config['reset_password_form']['description'] = 'Silakan masukkan username/email dan kata sandi anda untuk masuk log';

$config['send_again_form']['title'] = 'Masuk Log';
$config['send_again_form']['description'] = 'Silakan masukkan username/email dan kata sandi anda untuk masuk log';

$config['unregister_form']['title'] = 'Hapus Akun';
$config['unregister_form']['description'] = 'Anda membutuhkan kata sandi untuk melakukan operasi ini. Silakan masukkan kata sandi Anda';

$config['change_email_form']['title'] = 'Ubah alamat surel';
$config['change_email_form']['description'] = 'Silakan isikan alamat surel baru Anda. Anda juga membutuhkan kata sandi untuk melakukan operasi ini';

$config['change_password_form']['title'] = 'Ubah kata sandi';
$config['change_password_form']['description'] = '';

$config['forgot_password_form']['title'] = 'Lupa kata sandi';
$config['forgot_password_form']['description'] = 'Silakan masukkan alamat surel atau nama pengguna. Informasi tentang perubahan kata sandi akan dikirimkan ke alamat surel Anda';
