...
class Microblog extends MY_Controller {
            ...
            if($_POST){                 
                ...
                $row = $this->Message_model->get_messages($params)->num_rows();
                    ...
                    if($row>0){
                        ...
                        if(!is_null($callback))echo $callback.'('.json_encode($data).')';
    ...
    function get_incoming_messages($callback=NULL){
        ...
        function get_microblog_conversation($callback=NULL){
                ...
                header('Content-Type: application/json');
                if(!is_null($callback))echo $callback.'('.json_encode($conversation).')';
                else echo json_encode($conversation);
        ...
        function stream_map(){
            ...
            $this->load->view('front/stream_map',$data);
        }
